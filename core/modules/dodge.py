...
def apply_dodge(dmg: float, atk_attack: int, def_agility: int, defender_stamina: int, atk_agility: int = None, defender_modifiers=None) -> Tuple[float, str]:
    ...
    # Apply equipment dodge chance bonus
