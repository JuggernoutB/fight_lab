...
def calc_crit(att_agi: int, def_def: int, attacker_stamina: int, attacker_fatigue_bonus: float = 0.0, attacker_modifiers=None) -> bool:
    ...
    fatigue_multiplier = get_fatigue_multiplier(attacker_stamina, 'crit', attacker_modifiers)
...
def calc_crit_chance_only(att_agi: int, def_def: int, attacker_stamina: int, attacker_modifiers=None) -> float:
